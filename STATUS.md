...
order raises it to 66/90. The same batch restores the target and same-game
authenticated `activeNum = 0` initialization in `ev_Last5Coin40`, improving it
to 99.026596% without claiming an exact closure.
...
2026-07-15. Rows changed through Wave 77 were regenerated from the final
