...
#define ALIGN_NEXT(value, align) (((value) + ((align) - 1)) & ~((align) - 1))
...
static BOOL DBGWrite(u32, const u32*, s32);
...
static BOOL DBGWrite(u32 param1, const u32* data, s32 byte_size)
{
	BOOL error   = FALSE;
	const u32* dataPtr = data;
	u32 value;
	u32 nextWord;
