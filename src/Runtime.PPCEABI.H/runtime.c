...
#define SAVE_VR(reg)     _savev##reg
#define RESTORE_VR(reg)  _restv##reg
...
#ifdef MP6_FILESEL_RUNTIME
#define __div2u fn_1_E658
#define __div2i fn_1_E744
#define __mod2u fn_1_E87C
#define __mod2i fn_1_E960
#define __shl2i fn_1_EA6C
#define __shr2u fn_1_EA90
#define __shr2i fn_1_EAB4
#define __cvt_sll_dbl fn_1_EADC
#define __cvt_ull_dbl fn_1_EB8C
...
cvt_sll_dbl_abs:
    ...
    cmpwi r7, 0x400
    addi r6, r6, 0x43e
    blt cvt_sll_dbl_pack
    bgt cvt_sll_dbl_round
    rlwinm. r7, r4, 0, 0x14, 0x14
    beq cvt_sll_dbl_pack
cvt_sll_dbl_round:
    addic r4, r4, 0x800
    addze r3, r3
    addze r6, r6
...
asm void __cvt_ull_dbl(void)
{
    ...
    cmpwi r7, 0x400
    addi r6, r6, 0x43e
    blt cvt_ull_dbl_pack
    bgt cvt_ull_dbl_round
    rlwinm. r7, r4, 0, 0x14, 0x14
    beq cvt_ull_dbl_pack
cvt_ull_dbl_round:
    addic r4, r4, 0x800
    addze r3, r3
    addze r6, r6
...
asm void __cvt_ull_flt(void)
{
    ...
    cmpwi r7, 0x400
    addi r6, r6, 0x43e
    blt cvt_ull_flt_pack
    bgt cvt_ull_flt_round
    rlwinm. r7, r4, 0, 0x14, 0x14
    beq cvt_ull_flt_pack
cvt_ull_flt_round:
    addic r4, r4, 0x800
    addze r3, r3
    addze r6, r6
