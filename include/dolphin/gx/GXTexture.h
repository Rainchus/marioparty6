...
void GXInitTexObj(GXTexObj* obj, void* data, u16 width, u16 height, GXTexFmt format,
                  GXTexWrapMode wrapS, GXTexWrapMode wrapT, u8 mipmap);
void GXInitTexObjCI(GXTexObj* obj, void* data, u16 width, u16 height, GXCITexFmt format,
                    GXTexWrapMode wrapS, GXTexWrapMode wrapT, u8 mipmap, u32 tlut);
void GXInitTexObjData(GXTexObj* obj, void* data);
